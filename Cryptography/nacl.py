...
from Cryptography.NACLEncrypter import (
...
class NaCl:
        def __init__(self):
         ...
         self.server_private_key = bytearray(bytes(self.settings["NACLServerPrivateKey"], 'utf-8'))
        ...
        def decrypt(self, packet_id, payload):
         if packet_id == 10100:
            ...
            print(self.server_public_key.hex())
        ...
        def encrypt(self, packet_id, payload):
